...
- 📷小车基本功能如循迹测距避障，openmv可以对实际场景中的物体进行搜索和识别，可惜有些并没有拍照留存
...
- **2023.03-2023.06** 🚀 I2GSRnet: Iterative Interaction Guidance Network for Stereo Image Super-Resolution：立体图像（双目视觉）超分，效果为同时期SOTA水准，该论文已于ICME2024（IEEE International Conference on Multimedia and Expo, CCF-B类会议）发表；
...
- **2024.03-2024.07** 🚀 Degradation Intensity Modulation Transformer for Real-World Stereo Super-Resolution：立体图像（双目视觉）真实世界超分，效果远超现有单图盲超分和立体超分方法，且足够轻量化，更适用于真实场景；
- 📷 SR Results
